...
equilibriumKT = [
    ...
    [1600,  3.132,   6e-5,      0,      0,      0,      0,     0, 1.35e-6, 4.5e-6],
    ...
    [2700,  6.939, 0.0566, 0.0146, 0.0002,   3e-4,   5e-4,   2e-4,      0, 0.8e-5],
    [2800,  7.167, 0.0814, 0.0231, 0.0005,   5e-4, 0.0012,   5e-4,      0, 0.8e-5],
    [2900,  7.379, 0.1143, 0.0355, 0.0011,   8e-4, 0.0026, 0.0010,      0, 0.7e-5],
    [3000,  7.574, 0.1574, 0.0529, 0.0023, 0.0014, 0.0053, 0.0020,      0, 0.6e-5],
    [3100,  7.753, 0.2125, 0.0768, 0.0044, 0.0022, 0.0103, 0.0038,      0,      0],
    [3200,  7.917, 0.2813, 0.1089, 0.0081, 0.0035, 0.0190, 0.0071,      0,      0],
    [3300,  8.068, 0.3658, 0.1513, 0.0144, 0.0053, 0.0339, 0.0126,      0,      0],
    [3400,  8.205, 0.4682, 0.2064, 0.0248, 0.0078, 0.0586, 0.0216,      0,      0],
    [3500,  8.330, 0.5910, 0.2760, 0.0415, 0.0113, 0.0978, 0.0358,      0,      0],
    [3600,  8.443, 0.7367, 0.3626, 0.0674, 0.0161, 0.1591, 0.0580,      0,      0],
    [3700,  8.544, 0.9079, 0.4693, 0.1065, 0.0225, 0.2516, 0.0917,      0,      0],
    [3800,  8.633, 1.1070, 0.6001, 0.1642, 0.0309, 0.3886, 0.1412,      0,      0],
    [3900,  8.710, 1.3360, 0.7589, 0.2478, 0.0417, 0.5878, 0.2132,      0,      0],
    [4000,  8.775, 1.5970, 0.9495, 0.3663, 0.0554, 0.8711, 0.3157,      0,      0],
]
# fmt: on
