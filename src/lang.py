ENGLISH = {
    ...
    "plotText": " ".join(
        (
            ...
            "implying an even temperature distribution (∂T/∂x = 0).\n"
            "The validity of Lagrange's solution is based on the basis that",
            ...
            "face, tending to equialize the pressure distribution spatially.",
            ...
            "propagation of shockwave are clearly not iso-entropic, limiting",
            "its applicability to where both happen only sparringly.",
            "The Mamontov approximation is considered by some",
            "best suited to the case of high charge to weight, given that",
            "temperature tends to equialize more readily than other",
            "disturbances that propagate at local speed of sound.\n",
...
CHINESE = {
    ...
    "plotText": "".join(
        (
            ...
            "相比于拉格朗日解是更加宽松的假设。但是，需要指出，火药的燃烧，以及激波的传播显然是熵增过程",
            "因此对于高装药比时燃烧不均匀加剧，压力波可能转化为激波的情况，也不是严格适用的。对于更高装",
            "药比的情况，有一些观点认为虽然密度场的分布不一定均匀，但是温度场有可能，因此马蒙托夫近似解",
            "更适合这种情况。\n",
