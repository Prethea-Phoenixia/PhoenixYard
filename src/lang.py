ENGLISH = {
    ...
    "plotText": " ".join(
        (
            ...
            "distributed, and pressure, quadraticaly. Pidduck relaxed this",
            "assumption to isentropic (∂S/∂x = 0), which also implied linear",
            "velocity distribution, but exponentially distributed pressure.",
