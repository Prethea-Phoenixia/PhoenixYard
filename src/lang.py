ENGLISH = {
    ...
    "plotText": " ".join(
        (
            ...
            "The Pidduck approximation is taken at limit of quickly damped",
            "rarefraction waves and stabilized bore condition, therefore its",
            "applicability is also limited in the case of higher charge to",
            "shot ratio. Further, neither combustion nor shockwaves are",
            "isentropic processes, violating its theoretical basis.",
...
CHINESE = {
    ...
    "plotText": "".join(
        (
            ...
            "认为拉格朗日解成立。毕杜克极限解是压力波震荡衰减快，震荡阶段占比小时取得极限，其虽然不假设",
            "分布，但是要求过程绝热等熵。但是，火药的燃烧，以及激波的传播显然是熵增过程。",
            "对于高装药比时燃烧不均匀加剧，压力波可能转化为激波的情况，也不是严格适用的。对于更高装",
